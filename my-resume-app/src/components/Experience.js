        ...
        <div className="experience">
            ...
            <div className="job">
                <div className="job-details">
	                ...
	                <li>Updated On External Facing Articles: <em><a href="http://godaddy.com/help" target="_blank" rel="noreferrer"><b>GoDaddy Help Center</b></a></em></li>
                        <li>Beta Tested Cloud Servers: <em><a href="http://cloud.godaddy.com" target="_blank" rel="noreferrer"><b>Cloud Platform Hosting</b></a></em></li>
